...
To connect the [ESS-C3 shield](https://github.com/winkj/ess-hardware-docs/blob/master/ESS_Schematic.PDF)) to the Nano you can use the [TODO]() or a [NanUno v2](https://www.thingiverse.com/thing:4171213) hardware adapter.
