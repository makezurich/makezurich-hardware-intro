...
To connect the Murata board, see the wiring diagram below, and use the [LoRaWANModem library](https://github.com/2ni/lorawan_modem/) by [@2ni](https://twitter.com/2ni).
