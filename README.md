...
### Breadboard
A [breadboard](https://www.aliexpress.com/item/32690555189.html) allows you to prototype electronic circuits. Its holes are connected under the hood in columns, plus two rows for ground (GND, black or blue) and power (VCC, red).
